      ...
      <div className={`wrapper ${isRegistering ? "active" : ""}`}>
        ...
        <div className="info-text login">
          ...
          <p className="animation" style={{ "--i": 1, "--j": 21 }}>
            Login to explore a world of vaping and pod experiences.
          </p>
        </div>

        {/* Register Form */}
        <div className={`form-box register ${isRegistering ? "active" : ""}`}>
          <h2 className="animation signupinfo" style={{ "--i": 17, "--j": 1 }}>
            Sign Up
          </h2>
        ...
        <div className="info-text register">
          ...
          <p className="animation" style={{ "--i": 18, "--j": 1 }}>
            Sign up to discover new flavors and exclusive offers in the vaping
            world!
          </p>
        </div>
      </div>
